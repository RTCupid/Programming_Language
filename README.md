...
По результатам измерений (см. Таб. 1, 2) видно, что код на процессоре х86-64 выполнялся в 530 раз быстрее, чем на эмуляторе процессора. 

| Команда | Всего тестов | Среднее время выполнения, с| Минимальное время выполнения, с| Максимальное время выполнения, с|
|:---|---:|---:|---:|---:|
| `./processor/Run.exe Programm_code.txt` | 4 | 93.721 ± 0.670 | 93.041 | 94.625 |
