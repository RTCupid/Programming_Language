...
Реализация для эмулятора процессора состояла из генерации кода на моём ассемблере [[6]](/backend/hdr/MakeCodeAsm.h), [[7]](/backend/MakeCodeAsm.cpp), для дальнейшего преобразования в выполняемый код и выполнения в моём процессоре CPU. Для второго варианта написана генерация кода на ассемблере NASM [[8]](/x86_64_backend/hdr/MakeCodeNasm.h), [[9]](/x86_64_backend/MakeCodeNasm.cpp). Этот код затем компилировался при помощи NASM и выполнялся на процессоре архитектуры x86-64. 
