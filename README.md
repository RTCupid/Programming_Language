...
Написан фронтенд для моего языка программирования, обрабатывающий синтаксис функций, циклов, операторов условных переходов, операторов ввода и вывода целых чисел, оператора присваивания и сравнения.
