...
В промежуточном представлении код представлялся полной скобочной записью в префиксном формате. В миддленде из этого представления восстанавливалось абстрактное синтаксическое дерево, для которого можно провести такие оптимизации, как свёртка констант и удаление неиспользуемого кода (нейтральных выражений) (см. проект [Differentiator](https://github.com/RTCupid/Differentiator)). 
