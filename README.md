...
Покажем на нескольких небольших примерах цикл компиляции кода, написанного на моём языке программирования.

Рассмотрим следующий код, в котором выполняются простые операции:
