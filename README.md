...
После работы фронтэнда можно провести оптимизации с промежуточным представлением (IR). Например, можно выполнить свёртку констант и удаление нейтральных выражений (см. проект [Differentiator](https://github.com/RTCupid/Differentiator)).
